...
Нужен один файл: `GZP_Setup_<версия>_<релиз>.exe`.
Внутри него приложение, индикаторы MT4/MT5 и патч терминалов.

1. Скачайте установщик со страницы
   [Releases](https://github.com/VadimChudin/gzp/releases).
2. Запустите его и оставьте галочку «Установить индикатор в терминалы».
